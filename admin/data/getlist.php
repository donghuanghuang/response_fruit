...
//查询最大页码
$sql="select count(*) maxSize from o_user_list";
...
$sql="SELECT l.*,a.firstname,u.username,a.uaddress,a.uphone 
from o_user_list l,o_user_address 
a,o_user u where l.aid=a.aid and u.id=l.uid order by l.lid limit ".($pno-1)*$pageSize.",$pageSize";
